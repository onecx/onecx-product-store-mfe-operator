...
----
quarkus.operator-sdk.controllers.microfrontend.retry.max-attempts=10
quarkus.operator-sdk.controllers.microfrontend.retry.interval.initial=5000
quarkus.operator-sdk.controllers.microfrontend.retry.interval.multiplier=3
quarkus.operator-sdk.controllers.microfrontend.retry.interval.max=300000
...
include::onecx-product-store-mfe-operator-extensions.adoc[opts=optional]
